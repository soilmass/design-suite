...
| 7 | `docs/verification-1.0.0.md` | 1.0.4 | 3 | How do I confirm it? |
| 8 | `docs/diagnosis-1.0.0.md` | 1.0.2 | 3 | How do I read a site I did not build? |
| 9 | `docs/governance-1.0.0.md` | 1.0.1 | none | How does any of this change? |
